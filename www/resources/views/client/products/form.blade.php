...
<div class="w-full p-5 md:p-8">
    ...
    <x-ui.panel class="mt-6 border-[var(--ui-border)] shadow-none" padding="p-5 md:p-6">
        <form method="POST" action="{{ $product ? route('products.update', $product) : route('products.store') }}" class="grid gap-5 md:grid-cols-2">
            ...
            <div>
                <label class="mb-2 block text-sm font-medium text-[var(--ui-text-muted)]" for="sku">{{ __('product.sku') }}</label>
                <x-ui.input id="sku" name="sku" :value="old('sku', $product->sku ?? '')" required maxlength="80" />
                @error('sku')<p class="mt-2 text-sm text-[var(--ui-danger)]">{{ $message }}</p>@enderror
            </div>

            <div>
                <label class="mb-2 block text-sm font-medium text-[var(--ui-text-muted)]" for="product_type">{{ __('product.product_type') }}</label>
                ...
                @error('product_type')<p class="mt-2 text-sm text-[var(--ui-danger)]">{{ $message }}</p>@enderror
            </div>

            <div>
                <label class="mb-2 block text-sm font-medium text-[var(--ui-text-muted)]" for="lifecycle_status">{{ __('product.lifecycle_status') }}</label>
                ...
                @error('lifecycle_status')<p class="mt-2 text-sm text-[var(--ui-danger)]">{{ $message }}</p>@enderror
            </div>

            <div class="md:col-span-2">
                <label class="mb-2 block text-sm font-medium text-[var(--ui-text-muted)]" for="description">{{ __('product.description') }}</label>
            ...
            <div>
                <label class="mb-2 block text-sm font-medium text-[var(--ui-text-muted)]" for="unit_id">{{ __('product.unit_id') }}</label>
                ...
                <p class="mt-2 text-sm text-[var(--ui-text-muted)]">{{ __('product.uom_auto_fill_hint') }}</p>
                @error('unit_id')<p class="mt-2 text-sm text-[var(--ui-danger)]">{{ $message }}</p>@enderror
            </div>

            <div>
                <label class="mb-2 block text-sm font-medium text-[var(--ui-text-muted)]" for="category_id">{{ __('product.category_id') }}</label>
                ...
                @error('category_id')<p class="mt-2 text-sm text-[var(--ui-danger)]">{{ $message }}</p>@enderror
            </div>

            <div>
                <label class="mb-2 block text-sm font-medium text-[var(--ui-text-muted)]" for="brand_id">{{ __('product.brand_id') }}</label>
                ...
                @error('brand_id')<p class="mt-2 text-sm text-[var(--ui-danger)]">{{ $message }}</p>@enderror
            </div>

            <div>
                <label class="mb-2 block text-sm font-medium text-[var(--ui-text-muted)]" for="safety_stock">{{ __('product.safety_stock') }}</label>
                <x-ui.input id="safety_stock" type="number" min="0" name="safety_stock" :value="old('safety_stock', $product->safety_stock ?? 0)" required />
                @error('safety_stock')<p class="mt-2 text-sm text-[var(--ui-danger)]">{{ $message }}</p>@enderror
            </div>

            <div>
                <label class="mb-2 block text-sm font-medium text-[var(--ui-text-muted)]" for="lead_time_days">{{ __('product.lead_time_days') }}</label>
                ...
                @error('lead_time_days')<p class="mt-2 text-sm text-[var(--ui-danger)]">{{ $message }}</p>@enderror
            </div>
            ...
            <div class="md:col-span-2">
                <label class="mb-2 block text-sm font-medium text-[var(--ui-text-muted)]" for="alternate_uoms_json">{{ __('product.alternate_uoms') }}</label>
                ...
                @error('alternate_uoms_json')<p class="mt-2 text-sm text-[var(--ui-danger)]">{{ $message }}</p>@enderror
            </div>

            <div class="md:col-span-2">
                <label class="mb-2 block text-sm font-medium text-[var(--ui-text-muted)]" for="technical_attributes_json">{{ __('product.technical_attributes') }}</label>
                ...
                @error('technical_attributes_json')<p class="mt-2 text-sm text-[var(--ui-danger)]">{{ $message }}</p>@enderror
            </div>

            <div class="md:col-span-2">
                <label class="mb-2 block text-sm font-medium text-[var(--ui-text-muted)]" for="commercial_attributes_json">{{ __('product.commercial_attributes') }}</label>
                ...
                @error('commercial_attributes_json')<p class="mt-2 text-sm text-[var(--ui-danger)]">{{ $message }}</p>@enderror
            </div>

            <div class="md:col-span-2">
                <label class="mb-2 block text-sm font-medium text-[var(--ui-text-muted)]" for="image_urls_json">{{ __('product.image_urls') }}</label>
                ...
                @error('image_urls_json')<p class="mt-2 text-sm text-[var(--ui-danger)]">{{ $message }}</p>@enderror
            </div>

            <div class="md:col-span-2">
                <label class="mb-2 block text-sm font-medium text-[var(--ui-text-muted)]" for="attachment_urls_json">{{ __('product.attachment_urls') }}</label>
                ...
                @error('attachment_urls_json')<p class="mt-2 text-sm text-[var(--ui-danger)]">{{ $message }}</p>@enderror
            </div>
