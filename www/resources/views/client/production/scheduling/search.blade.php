...
<div class="w-full p-5 md:p-8">
    <div class="flex flex-wrap items-end justify-between gap-4">
        ...
        <x-ui.button :href="route('production.scheduling.create')" variant="brand-primary" class="rounded-full">{{ __('production.scheduling.new') }}</x-ui.button>
    </div>

    <x-ui.panel class="mt-6 border-[#dadce0] shadow-none" padding="p-6">
        <p class="text-sm text-[#5f6368]">{{ __('production.scheduling.description') }}</p>
    </x-ui.panel>
</div>
@endsection
