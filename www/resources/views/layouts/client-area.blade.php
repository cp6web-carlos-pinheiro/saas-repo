...
@section('content')
    @php
        ...
        $moduleSubitems = [
            ...
            'inventory' => [
                ['label' => __('ui.inventory_branches'), 'href' => route('inventory.branches.index'), 'active' => request()->routeIs('inventory.branches.*')],
                ...
                ['label' => __('ui.inventory_warehouse_locations'), 'href' => route('inventory.warehouse-locations.index'), 'active' => request()->routeIs('inventory.warehouse-locations.*')],
                ['label' => __('ui.admin_departments'), 'href' => route('admin-data.index', ['domain' => 'departments']), 'active' => request()->routeIs('admin-data.*') && request()->route('domain') === 'departments'],
                ['label' => __('ui.admin_cost_centers'), 'href' => route('admin-data.index', ['domain' => 'cost-centers']), 'active' => request()->routeIs('admin-data.*') && request()->route('domain') === 'cost-centers'],
                ...
                ['label' => __('ui.admin_ncms'), 'href' => route('admin-data.index', ['domain' => 'ncms']), 'active' => request()->routeIs('admin-data.*') && request()->route('domain') === 'ncms'],
                ['label' => __('ui.admin_cfops'), 'href' => route('admin-data.index', ['domain' => 'cfops']), 'active' => request()->routeIs('admin-data.*') && request()->route('domain') === 'cfops'],
                ['label' => __('ui.admin_taxes'), 'href' => route('admin-data.index', ['domain' => 'taxes']), 'active' => request()->routeIs('admin-data.*') && request()->route('domain') === 'taxes'],
