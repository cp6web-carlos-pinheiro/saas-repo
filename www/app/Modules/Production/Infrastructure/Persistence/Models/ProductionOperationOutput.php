...
final class ProductionOperationOutput extends TenantModel
{
    ...
    public function productionOrder(): BelongsTo { return $this->belongsTo(ProductionOrder::class, 'production_order_id'); }

    public function getQuantityCompletedAttribute(): float { return (float) $this->quantity_good; }
    public function getProducedAtAttribute(): mixed { return $this->reported_at; }
    public function getOperationNoAttribute(): ?int { return $this->operation?->operation_no; }
}
