        ...
        $rows = DB::select(
            ...
            WITH RECURSIVE bom_tree AS (
                SELECT
                    ...
                    bi.quantity_per,
                    bi.scrap_factor,
                    (bi.quantity_per * (1 + (bi.scrap_factor / 100))) AS quantity_required,
                    (bi.quantity_per * (1 + (bi.scrap_factor / 100))) AS quantity_accumulated,
                    1 AS level,
                ...
                SELECT
                    ...
                    child_bi.scrap_factor,
                    (child_bi.quantity_per * (1 + (child_bi.scrap_factor / 100))) AS quantity_required,
                    (bt.quantity_accumulated * (child_bi.quantity_per * (1 + (child_bi.scrap_factor / 100)))) AS quantity_accumulated,
                    bt.level + 1 AS level,
