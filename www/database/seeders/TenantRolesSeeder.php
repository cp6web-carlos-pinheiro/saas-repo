        ...
        $roleMatrix = [
            'planner' => [
                ...
                'permissions' => [
                    ...
                    'production-order-operations.read', 'production-order-operations.plan', 'production-schedules.read', 'production-schedules.create', 'production-schedules.compare', 'mrp-runs.read', 'mrp-suggestions.read', 'mrp-suggestions.approve', 'mrp-suggestions.reject', 'mrp-suggestions.convert',
                    'mes-operations.read', 'mes-operations.execute', 'mes-operations.report', 'mes-quality.report', 'mes-quality.rework',
                    'analytics.manufacturing.read', 'manufacturing-reports.read',
                    'bom.explode',
                    'mrp.plan',
            ...
            'supervisor' => [
                ...
                'permissions' => [
                    ...
                    'production-calendar.generate',
                    'production-scheduling.run',
                    'production-order-operations.read', 'production-order-operations.plan', 'production-schedules.read', 'production-schedules.create', 'production-schedules.publish', 'production-schedules.cancel', 'production-schedules.compare', 'mrp-runs.read', 'mrp-suggestions.read', 'mrp-suggestions.approve', 'mrp-suggestions.reject', 'mrp-suggestions.convert',
                    'mes-operations.read', 'mes-operations.execute', 'mes-operations.report', 'mes-operations.correct', 'mes-quality.report', 'mes-quality.rework', 'production-orders.consumption.reverse',
                    'analytics.manufacturing.read', 'analytics.standard-times.recommend', 'analytics.standard-times.decide', 'manufacturing-reports.read', 'manufacturing-reports.export',
                    'bom.explode',
                    'mrp.plan',
                    'routing-versions.read',
